...
import { FirstloginComponent } from 'app/entities/firstlogin/firstlogin.component';
...
describe('Component Tests', () => {
  describe('Firstlogin Management Component', () => {
    let comp: FirstloginComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(FirstloginComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.firstlogins && comp.firstlogins[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
