...
import { CommandeVehiculeComponent } from 'app/entities/commande-vehicule/commande-vehicule.component';
...
describe('Component Tests', () => {
  describe('CommandeVehicule Management Component', () => {
    let comp: CommandeVehiculeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CommandeVehiculeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.commandeVehicules && comp.commandeVehicules[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
