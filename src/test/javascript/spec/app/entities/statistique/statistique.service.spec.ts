...
describe('Service Tests', () => {
  describe('Statistique Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(StatistiqueService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Statistique(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Statistique', () => {
        ...
        service.create(new Statistique()).subscribe(resp => (expectedResult = resp.body));
