...
import { StatistiqueComponent } from 'app/entities/statistique/statistique.component';
...
describe('Component Tests', () => {
  describe('Statistique Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.statistiques && comp.statistiques[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
