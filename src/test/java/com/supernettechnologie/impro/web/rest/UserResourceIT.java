...
public class UserResourceIT {
    ...
    public void setup() {
        ...
        UserResource userResource = new UserResource(userService, userRepository, mailService, personnePhysiqueRepository, personnePhysiqueMapper,  docIdentificationPPRepository, docIdentificationPPMapper);
