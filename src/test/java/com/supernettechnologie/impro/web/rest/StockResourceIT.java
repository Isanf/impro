...
public class StockResourceIT {
    ...
    private static final String DEFAULT_NUMERO_STOCK = "AAAAAAAAAA";
    private static final String UPDATED_NUMERO_STOCK = "BBBBBBBBBB";

    private static final ZonedDateTime DEFAULT_DATE_STOCK = ZonedDateTime.ofInstant(Instant.ofEpochMilli(0L), ZoneOffset.UTC);
    private static final ZonedDateTime UPDATED_DATE_STOCK = ZonedDateTime.now(ZoneId.systemDefault()).withNano(0);
    ...
    public static Stock createEntity(EntityManager em) {
        Stock stock = new Stock()
            .numeroStock(DEFAULT_NUMERO_STOCK)
            .dateStock(DEFAULT_DATE_STOCK);
        return stock;
    }
    /**
    ...
    public static Stock createUpdatedEntity(EntityManager em) {
        Stock stock = new Stock()
            .numeroStock(UPDATED_NUMERO_STOCK)
            .dateStock(UPDATED_DATE_STOCK);
        return stock;
    }
    ...
    public void createStock() throws Exception {
        ...
        assertThat(testStock.getNumeroStock()).isEqualTo(DEFAULT_NUMERO_STOCK);
        assertThat(testStock.getDateStock()).isEqualTo(DEFAULT_DATE_STOCK);
    }
    ...
    public void getAllStocks() throws Exception {
        ...
        restStockMockMvc.perform(get("/api/stocks?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].numeroStock").value(hasItem(DEFAULT_NUMERO_STOCK)))
            .andExpect(jsonPath("$.[*].dateStock").value(hasItem(sameInstant(DEFAULT_DATE_STOCK))));
    }
    ...
    public void getStock() throws Exception {
        ...
        restStockMockMvc.perform(get("/api/stocks/{id}", stock.getId()))
            ...
            .andExpect(jsonPath("$.numeroStock").value(DEFAULT_NUMERO_STOCK))
            .andExpect(jsonPath("$.dateStock").value(sameInstant(DEFAULT_DATE_STOCK)));
    }
    ...
    public void updateStock() throws Exception {
        ...
        Stock testStock = stockList.get(stockList.size() - 1);
        assertThat(testStock.getNumeroStock()).isEqualTo(UPDATED_NUMERO_STOCK);
        assertThat(testStock.getDateStock()).isEqualTo(UPDATED_DATE_STOCK);
    }
